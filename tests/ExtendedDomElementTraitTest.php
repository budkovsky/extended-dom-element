...
use Budkovsky\ExtendedDomElement\DOMBuilder;
use Budkovsky\ExtendedDomElement\DOMBuilderInterface;
...
final class ExtendedDomElementTraitTest extends TestCase
{
    ...
    public function testCanBeUsedToDomBuilderInterfaceImplementation(): void
    {
        $this->assertInstanceOf(
            DOMBuilderInterface::class,
            new class implements DOMBuilderInterface {
                use ExtendedDomElementTrait;
            }
        );
    }
